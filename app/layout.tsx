...
export const metadata: Metadata = {
  ...
  title: {
    default: "Mortgage Calculator 2026 | Free Monthly Payment Calculator",
  ...
  openGraph: {
    ...
    description:
      "Calculate your exact monthly mortgage payment in seconds. Includes taxes, insurance, PMI, and current 2026 rates.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "MortCalc.org - Free Mortgage Calculator 2026",
      },
    ],
  },
  twitter: {
